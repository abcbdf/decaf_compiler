...
public abstract class Tree {
    ...
    public static final int DO = RETURN + 1;
    public static final int COND = DO + 1;

    /**
     * Throw statements, of type Throw.
     */
    public static final int THROW = COND + 1;
    ...
    public static final int CASEPAIR = CASEEXPR + 1;
    public static final int DEFCASEPAIR = CASEPAIR + 1;
    public static final int SUPEREXPR = DEFCASEPAIR + 1;
    ...
    public static final int IMGCONST = COMPLEX + 1;
    ...
    public static class Do extends Tree {
		public List<Cond> branches;
		public Do(List<Cond> branches, Location loc) {
			super(DO, loc);
    ...
    public static class Cond extends Tree {
		public Expr expr;
		public Tree statement;
		public Cond(Expr expr, Tree statement, Location loc) {
			super(COND, loc);
			this.expr = expr;
    ...
    public static class CaseExpr extends Expr {
		public Expr cond;
		public List<CasePair> pairs;
		public DefCasePair pair;
		public CaseExpr(Expr cond, List<CasePair> pairs,
				DefCasePair pair, Location loc) {
			super(CASEEXPR, loc);
			this.cond = cond;
			this.pairs = pairs;
			this.pair = pair;
    	...
    	public void printTo(IndentPrintWriter pw) {
			...
			pw.println("cases");
			pw.incIndent();
			for(CasePair pair : this.pairs)
				pair.printTo(pw);
			this.pair.printTo(pw);
			pw.decIndent();
			pw.decIndent();
		}
}

public static class CasePair extends Tree {
		public Expr l;
		public Expr expr;
		public CasePair(Expr l, Expr expr, Location loc) {
			super(CASEPAIR, loc);
			this.l = l;
			this.expr = expr;
		}
	...
	public static class DefCasePair extends Tree	{
		public Expr expr;
		public DefCasePair(Expr expr, Location loc) {
			super(DEFCASEPAIR, loc);
			this.expr = expr;
		}
		@Override
	    	public void accept(Visitor visitor) {
	    		visitor.visitDefCasePair(this);
	    	}
			@Override
	    	public void printTo(IndentPrintWriter pw) {
			pw.println("default");
...
public static class DCopyExpr extends Expr {
    ...
    public static abstract class Visitor {
	    ...
	    public void visitCasePair(CasePair that) {
				visitTree(that);
	    }
	    
	    public void visitDefCasePair(DefCasePair that) {
			visitTree(that);
	    }
	    ...
	    public void visitCond(Cond that) {
			visitTree(that);
	    }
