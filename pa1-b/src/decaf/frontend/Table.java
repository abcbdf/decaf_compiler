 ...
 * Specification file: F:\homework\coding\compiler_construction\pa1-b\src\decaf\frontend\Parser.spec
 * Options: unstrict mode
 * Generated at: Sat Nov 11 23:39:43 CST 2017
...
public class Table
 {
    ...
    public static final int CASE = 275; //# line 17
    public static final int DCOPY = 276; //# line 18
    public static final int DO = 277; //# line 18
    public static final int COMPLEX = 278; //# line 18
    public static final int SCOPY = 279; //# line 18
    public static final int SUPER = 280; //# line 18
    public static final int PRINTCOMP = 281; //# line 18
    public static final int SEPARATOR = 282; //# line 18
    public static final int OD = 283; //# line 19
    public static final int DEFAULT = 284; //# line 19
    public static final int LITERAL = 285; //# line 20
    public static final int IDENTIFIER = 286; //# line 21
    public static final int AND = 287; //# line 21
    public static final int OR = 288; //# line 21
    public static final int STATIC = 289; //# line 21
    public static final int INSTANCEOF = 290; //# line 21
    public static final int LESS_EQUAL = 291; //# line 22
    public static final int GREATER_EQUAL = 292; //# line 22
    public static final int EQUAL = 293; //# line 22
    public static final int NOT_EQUAL = 294; //# line 22
    ...
    public static final int ACaseList = 316;
    ...
    public static final int DoList = 357;
    ...
    private final String[] allSymbols = {
        ...
        "PRINT", "READ_INTEGER", "READ_LINE", "CASE", "DCOPY",
        "DO", "COMPLEX", "SCOPY", "SUPER", "PRINTCOMP",
        "SEPARATOR", "OD", "DEFAULT", "LITERAL", "IDENTIFIER",
        "AND", "OR", "STATIC", "INSTANCEOF", "LESS_EQUAL",
        "GREATER_EQUAL", "EQUAL", "NOT_EQUAL", "VariableDef", "DoSubStmt",
        ...
        "Constant", "SubVariableList", "PrintStmt", "ForStmt", "ACaseList",
        ...
        "DoList", "ExprT8", "DefaultExpr", "Expr7", "ClassList",
        "Oper4", "Field",
    };
    ...
    private final Integer[][] beginRaw = {
        ...
        {SEPARATOR},
        {LITERAL, NULL, READ_INTEGER, READ_LINE, THIS, SUPER, NEW, INSTANCEOF, DCOPY, SCOPY, CASE, Integer.valueOf('('), IDENTIFIER},
        {CASE, Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, SCOPY, Integer.valueOf('@'), IDENTIFIER, NEW, Integer.valueOf('$'), THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('#'), DCOPY, SUPER, READ_INTEGER},
        {OR},
        {ELSE, PRINT, CASE, COMPLEX, VOID, FOR, Integer.valueOf('!'), SEPARATOR, Integer.valueOf('-'), CLASS, PRINTCOMP, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), Integer.valueOf('@'), DO, IDENTIFIER, NEW, Integer.valueOf('$'), IF, THIS, INSTANCEOF, STRING, LITERAL, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('#'), OD, DCOPY, BOOL, SUPER, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        {INT, COMPLEX, VOID, BOOL, STRING, CLASS},
        {WHILE},
    ...
    private final Integer[][] followRaw = {
        {PRINT, CASE, COMPLEX, VOID, FOR, Integer.valueOf('!'), SEPARATOR, Integer.valueOf('-'), CLASS, PRINTCOMP, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), Integer.valueOf('@'), DO, IDENTIFIER, NEW, Integer.valueOf('$'), IF, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('#'), OD, DCOPY, BOOL, SUPER, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {SEPARATOR, OD},
        ...
        switch (nonTerminal) {
            ...
            case ACaseList: {
                switch (lookahead) {
                    case LITERAL:
                    case NULL:
                        return new Pair<>(35, Arrays.asList(ACaseExpr, ACaseList));
                    case DEFAULT:
                        return new Pair<>(36, Arrays.asList());
                    default: return null;
                }
            }
            //# line 830
            case DoBranch: {
                switch (lookahead) {
                    case SEPARATOR:
                        return new Pair<>(37, Arrays.asList(SEPARATOR, DoSubStmt));
                    default: return null;
                }
            }
            //# line 623
            case Expr9: {
                switch (lookahead) {
                    ...
                    case CASE:
                        return new Pair<>(47, Arrays.asList(CASE, Integer.valueOf('('), Expr, Integer.valueOf(')'), Integer.valueOf('{'), ACaseList, DefaultExpr, Integer.valueOf('}')));
                    case '(':
            ...
            case ACaseExpr: {
                switch (lookahead) {
                    case LITERAL:
                    case NULL:
                        return new Pair<>(56, Arrays.asList(Constant, Integer.valueOf(':'), Expr, Integer.valueOf(';')));
                    default: return null;
                }
            }
            //# line 747
            ...
            case DoStmt: {
                switch (lookahead) {
                    case DO:
                        return new Pair<>(69, Arrays.asList(DO, DoList, OD));
                    default: return null;
                }
            }
            //# line 29
            ...
            case SimpleType: {
                switch (lookahead) {
                    ...
                    case COMPLEX:
                        return new Pair<>(104, Arrays.asList(COMPLEX));
                    case VOID:
            ...
            case DoList: {
                switch (lookahead) {
                    ...
                    case SUPER:
                    case READ_INTEGER:
                        return new Pair<>(122, Arrays.asList(DoSubStmt, DoBranchList));
                    default: return null;
                }
            }
            //# line 591
    ...
    public void act(int id, SemValue[] params) {
        switch (id) {
            ...
            case 1: {
                //# line 836
                params[0].stmt = new Tree.DoSubStmt(params[1].loc, params[1].expr, params[3].stmt);
                return;
            }
            case 2: {
                //# line 516
            ...
            case 15: {
                //# line 369
                params[0].counter = Tree.DOL;
                params[0].loc = params[1].loc;
                return;
            }
            case 16: {
                //# line 374
                params[0].counter = Tree.POUND;
                params[0].loc = params[1].loc;
                return;
            }
            case 17: {
            ...
            case 37: {
                //# line 831
                params[0].stmt = new Tree.DoBranch(params[1].loc, params[2].stmt);
                return;
            }
            case 38: {
                //# line 624
            ...
            case 45: {
                //# line 656
                params[0].expr = new Tree.DcopyExpr(params[1].loc, params[3].expr);
                return;
            }
            case 46: {
                //# line 660
                params[0].expr = new Tree.ScopyExpr(params[1].loc, params[3].expr);
                return;
            }
            case 47: {
                //# line 664
                params[0].expr = new Tree.CaseExpr(params[1].loc, params[3].expr, params[6].elist, params[7].expr);
                return;
            }
            case 48: {
                //# line 668
            ...
            case 56: {
                //# line 772
                params[0].expr = new Tree.ACaseExpr(params[1].loc, params[1].expr, params[3].expr);
                return;
            }
            case 57: {
                //# line 748
            ...
            case 69: {
                //# line 805
                params[0].stmt = new Tree.DoStmt(params[1].loc, params[2].slist);
                return;
            }
            case 70: {
                //# line 30
            ...
            case 126: {
                //# line 778
                params[0].expr = new Tree.DefaultExpr(params[1].loc, params[3].expr);
                return;
            }
            case 127: {
                //# line 562
