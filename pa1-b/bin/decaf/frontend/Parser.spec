...
PRINT  READ_INTEGER         READ_LINE   CASE
DCOPY   DO   COMPLEX    SCOPY   SUPER   PRINTCOMP   SEPARATOR
OD  DEFAULT
LITERAL
...
DoStmt          :   DO DoList OD
                    {
                       $$.stmt = new Tree.DoStmt($1.loc, $2.slist);
                    }
                ;
                
DoList          :   DoSubStmt DoBranchList
                    {
...
DoBranch        :   SEPARATOR DoSubStmt 
                    {
                        $$.stmt = new Tree.DoBranch($1.loc, $2.stmt);
                    }
                ;
DoSubStmt       :   Expr ':' Stmt
                    {
