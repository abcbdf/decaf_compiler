...
public abstract class Tree {
    ...
    public static final int AT = NEG + 1;
    public static final int DOL = AT + 1;
    public static final int POUND = DOL + 1;
    public static final int NOT = POUND + 1;
    ...
    public static final int CASEEXPR = SCOPYEXPR + 1;
    public static final int DEFAULTEXPR = CASEEXPR + 1;
    public static final int ACASEEXPR = DEFAULTEXPR + 1;
    public static final int READINTEXPR = ACASEEXPR + 1;
    ...
    public static final int DOSTMT = PRINTCOMP + 1;
    public static final int DOBRANCH = DOSTMT + 1;
    public static final int DOSUBSTMT = DOBRANCH + 1;
    ...
    public static final int COMPLEX = INT + 1;
    public static final int BOOL = COMPLEX + 1; 
   ...
   public static class CaseExpr extends Expr {
   	...
   	public Expr condition;
   	public List<Expr> Body;
   	public Expr defaultexpr; 

       public CaseExpr(Location loc, Expr condition, List<Expr> Body, Expr defaultexpr) {
           super(CASEEXPR, loc);
           this.condition = condition;
           this.Body = Body;
   ...
   public static class ACaseExpr extends Expr {
	       ...
	       public ACaseExpr(Location loc, Expr cond, Expr result) {
	           super(ACASEEXPR, loc);
	           this.cond = cond;
	           this.result = result;
	       }
   ...
   public static class DefaultExpr extends Expr {
	       ...
	       public DefaultExpr(Location loc, Expr result) {
   ...
   public static class DoStmt extends Tree {
	   	...
	   	public List<Tree> dobranch; 
	   	public Tree dosubstmt; 

	       public DoStmt(Location loc, List<Tree> dobranch, Tree dosubstmt) {
	           super(DOSTMT, loc);
	   	...
	   	public void printTo(IndentPrintWriter pw) {
	   		...
	   		pw.println("branches");
	   		pw.incIndent();
	   		for(int i = 0; i < dobranch.size(); i ++)
	   		{
	   			dobranch.get(i).printTo(pw);
	   		}
   ...
   public static class DoBranch extends Tree {
	       ...
	       public DoBranch(Location loc, Tree dosubstmt) {
	           super(DOBRANCH, loc);
	           this.dosubstmt = dosubstmt;
	       }
   ...
   public static class DoSubStmt extends Tree {
	       ...
	       public DoSubStmt(Location loc, Expr cond, Tree result) {
	           super(DOSUBSTMT, loc);
	           this.cond = cond;
	           this.result = result;
	       }
    ...
    public static class DcopyExpr extends Expr {
    	...
    	public DcopyExpr(Location loc, Expr expr) {
    		super(DCOPYEXPR, loc);
    		this.expr = expr;
    	}
    ...
    public static class ScopyExpr extends Expr {
    	...
    	public ScopyExpr(Location loc, Expr expr) {
    		super(SCOPYEXPR, loc);
    		this.expr = expr;
    	}
